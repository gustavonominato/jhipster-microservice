...
import br.com.service.web.rest.errors.ExceptionTranslator;
...
import static br.com.service.web.rest.TestUtil.createFormattingConversionService;
...
public class PessoaResourceIT {
    ...
    public static Pessoa createEntity(EntityManager em) {
        Pessoa pessoa = new Pessoa()
            .nome(DEFAULT_NOME)
            .cpf(DEFAULT_CPF)
            .data_nascimento(DEFAULT_DATA_NASCIMENTO);
        return pessoa;
    }
    /**
    ...
    public static Pessoa createUpdatedEntity(EntityManager em) {
        Pessoa pessoa = new Pessoa()
            .nome(UPDATED_NOME)
            .cpf(UPDATED_CPF)
            .data_nascimento(UPDATED_DATA_NASCIMENTO);
        return pessoa;
    }
    ...
    public void createPessoa() throws Exception {
        ...
        assertThat(testPessoa.getData_nascimento()).isEqualTo(DEFAULT_DATA_NASCIMENTO);
    }
    ...
    @Test
    @Transactional
    public void checkData_nascimentoIsRequired() throws Exception {
        int databaseSizeBeforeTest = pessoaRepository.findAll().size();
        // set the field null
    ...
    public void getAllPessoas() throws Exception {
        ...
        restPessoaMockMvc.perform(get("/api/pessoas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].data_nascimento").value(hasItem(DEFAULT_DATA_NASCIMENTO.toString())));
    }
    ...
    public void getPessoa() throws Exception {
        ...
        restPessoaMockMvc.perform(get("/api/pessoas/{id}", pessoa.getId()))
            ...
            .andExpect(jsonPath("$.data_nascimento").value(DEFAULT_DATA_NASCIMENTO.toString()));
    }
    ...
    public void updatePessoa() throws Exception {
        ...
        assertThat(testPessoa.getData_nascimento()).isEqualTo(UPDATED_DATA_NASCIMENTO);
    }
